#ifndef MARKETTABLEVIEW_QH_H
#define MARKETTABLEVIEW_QH_H
...
class MarketTableView_qh : public QTableView
{
    Q_OBJECT
public:
...
public:
    explicit MarketTableView_qh(QSplitter *spliter,QAbstractItemModel* model = 0, QWidget* parent = 0);
	//MarketTableView(QSplitter *spliter);
    virtual ~MarketTableView_qh();
